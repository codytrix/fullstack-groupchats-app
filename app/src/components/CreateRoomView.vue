<template>
  ...
  <div class="mx-auto max-w-7xl py-8 sm:px-6 lg:px-8">
        ...
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            ...
            <p class="mt-1 text-sm text-gray-600">
              Enter the following information and personalize the chat
              experience. This information will be displayed publicly so be
              ...
              <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                ...
                <div>
                  ...
                  <p class="mt-2 text-sm text-gray-500">
                    Brief description of the room. URLs are hyperlinked.
                  </p>
                </div>
    ...
    <div class="flex flex-row-reverse bg-gray-50 px-4 py-3 text-right sm:px-6">
      <button
        v-if="!loading"
        @click="sendForm"
        type="submit"
...
const sendForm = async () => {
  if (!roomFormErr.value.cover.length) {
    ...
    await store
      .dispatch("createRoom", { formData: formData.value })
      .then(() => {
        loading.value = false;
